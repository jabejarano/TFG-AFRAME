...
AFRAME.registerComponent('menu-light', {
    ...
    toggleMenu: function () {
      ...
      if (this.menuSphere) {
        ...
        option1.setAttribute('option', 'figure: #figura1; name: Sub Opcion A; pinchable: true; scale: 0.15 0.15 0.15; text-scale: 2 2 2; text-position: 0 0.5 0');
        option1.setAttribute('position', '0 0.1 0');
        option1.setAttribute('toggle-light', '');
  
        var option2 = document.createElement('a-entity');
        option2.setAttribute('option', 'figure: #figura2; name: Sub Opcion B; pinchable: true; scale: 0.15 0.15 0.15; text-scale: 2 2 2; text-position: 0 0.5 0');
        option2.setAttribute('position', '0 -0.1 0');
  
        var option3 = document.createElement('a-entity');
        option3.setAttribute('option', 'figure: #figura3; name: Sub Opcion C; pinchable: true; scale: 0.15 0.15 0.15; text-scale: 2 2 2; text-position: 0 0.5 0');
